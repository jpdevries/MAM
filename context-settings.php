                            ...
                            <div id="resource-view-reactable">
                                ...
                                <table border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tbody id="resource-view-body">
                                        <tr>
                                            <td><i class="fa fa-file-text-o" title="Context Settings Concept"></i>&nbsp;<a href="#" title="ID: 2; Published"><strong>Context Settings Concept</strong></a></td>
...
<?php get_main_nav(); ?>
        ...
        <div class="page-wrapper" style="padding-bottom:6em">
            <div class="dashbox">
                <div class="shell">
                    <div class="box">
                        <h2><i class="fa fa-gears"></i><br>Context Settings
                        ...
                        <form>
                            <fieldset>
                                ...
                                <input type="text" name="key" value="web" id="key">
                            </fieldset>
                            <fieldset>
                            ...
                            <fieldset>
                                ...
                                <textarea type="text" name="description" value="" id="description" placeholder="Brief descriptoin of your context" rows="3"></textarea>
                            </fieldset>
                            <button style="margin-bottom:2em" disabled>Update Context</button>
                            <label for="users_search" style="margin-bottom:0.25em">Filter Context Settings&nbsp;&nbsp;<a href="#" title="Learn more about the powerful uber syntax."><i class="fa fa-info-circle"></i></a></label>
...
{"title":"ƒ Florin Sign","clip":"ƒ"}]
                ...
                <div class="shell shell-access-permissions">
                    <div class="box">
                        <h2><i class="fa fa-gear"></i><br><!--input type="checkbox"-->Access Permisions</input></h2>
                        <br>
                        <table>
                            <thead>
                                <tr>
                        ...
                        <p class="nued" style="text-align:center"><i class="fa fa-info-circle"></i></p>
                        <aside>
                            <p><small>Access permissions allow you to configure what users can access given datasets.</small></p>
                        </aside>
                        <!--a href=""><button>update clipsJson</button></a-->
                    </div>
                </div>
