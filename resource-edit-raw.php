...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="<?php echo 'assets/css/main.css?nc=' . time() ?>">
    ...
    <body class="resource-edit">
        ...
        <section id="above-fold">
            <div class="page-wrapper" style="padding-top:0.2em">
<?php include 'functions.php';//get_settings_nav(); ?>
                <!--div class="resources">
                            ...
                            <div id="resource-view-reactable">
                                <h4>
                                    ...
                                    <div class="codepath">
                                        ...
                                        <pre title="Imagine this is interactive, terminal like with tab-to-complete">/</pre>
                                    </div>
                                </h4>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tbody id="resource-view-body">
                                        <tr>
                                            <td><i class="fa fa-folder" title="Contains 2 children"></i>&nbsp;<a href="#" title="ID: 1; Unpublished; Hidden from Menus">Container A</a></td>
                                            <td>Intro Text A</td>
                                            <td>Today</td>
                                        </tr>
                                        <tr>
                                            <td><i class="fa fa-folder" title="Contains 1 child"></i>&nbsp;<a href="#">Container B</a></td>
                                            <td>Intro Text B</td>
                                            <td>Yesterday</td>
                                        </tr>
                                        <tr>
                                            <td><i class="fa fa-folder" title="Contains 123 children"></i>&nbsp;<a href="#">Container C</a></td>
                                            <td>Intro Text C</td>
                                            <td>15 days ago</td>
                                        </tr>
                                        <tr>
                                            <td><i class="fa fa-link"></i>&nbsp;<a href="#">Weblink D</a></td>
                                            <td>Intro Text D</td>
                                            <td>17 days ago</td>
                                        </tr>
                                        <tr>
                                            <td><i class="fa fa-file-text"></i>&nbsp;<a href="#">Resource E</a></td>
                                            <td>Intro Text E</td>
                                            <td>19 days ago</td>
                                        </tr>
                                    </tbody>
            ...
            <div class="dashbox">
                ...
                <div class="shell shell-resource-groups">
                    <section id="resource-groups" class="box">
                        ...
                        <br>
                        <nav class="grid-nav" style="margin-bottom:1.5em">
...
<?php get_footer_markup(); ?></body></html>
